package com.axonivy.utils.masterdetail.test;
...
public class ProductListDemoWebIT {
	...
	public void createTestData() {
		...
		open(EngineUrl.createProcessUrl("master-detail-utils/1887B5D187E6060D/createTestData.ivp"));
	}
	...
	private void openProductList() {
		// valid links can be copied from the start page of the internal web-browser
		open(EngineUrl.createProcessUrl("master-detail-utils/188341B154DAFDDD/showProductList.ivp"));
